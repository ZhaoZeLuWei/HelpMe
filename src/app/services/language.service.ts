  ...
  private translations = {
    zh: {
      ...
      tab4: {
        ...
        // 收藏弹窗
        favoritesTitle: '我的收藏',
        favoritesDesc: '当前已关注{count}个事件',
        loading: '加载中...',
        noFavorites: '暂无收藏',
        noFavoritesHint: '收藏感兴趣的事件，随时查看',
        // 关注弹窗
        followsTitle: '关注的人',
        followsDesc: '当前已关注{count}名用户',
        followersTitle: '我的粉丝',
        noFollows: '暂未关注任何人',
      ...
      chatDetail: {
        ...
        systemConnected: '已连接至通知中心',
        userJoined: '{name}已加入，可以开始聊天了',
        buyer: '买家',
        seller: '卖家',
        deliveryAddress: '交付地址',
        additionalInfo: '补充信息',
      ...
      banAppeal: {
        pageTitle: '账号封禁',
        banTitle: '您的账号已被封禁',
        banDesc: '如有疑问或需要申诉，请在下方填写申诉内容，管理员会尽快处理。',
        appealTitle: '提交申诉',
        appealHint: '请详细描述您的情况，以便管理员审核（5-500字）。',
        inputPlaceholder: '请输入申诉内容...',
        submitBtn: '提交申诉',
        submitting: '提交中...',
        submitSuccess: '申诉已提交',
        submitFailed: '提交失败，请稍后重试',
        successTitle: '申诉已提交',
        successDesc: '管理员会尽快审核您的申诉，请耐心等待。',
        viewReplies: '查看管理员回复',
        hideReplies: '收起回复',
        noReplies: '暂无回复，请提交申诉后等待管理员处理。',
        adminReply: '管理员',
        me: '我',
        refresh: '刷新',
        backBtn: '返回',
    ...
    en: {
      ...
      login: {
        ...
        captchaInProgress: 'Please complete the current captcha',
      ...
      chatDetail: {
        ...
        systemConnected: 'Connected to notification center',
      ...
      banAppeal: {
        ...
        banTitle: 'Your account has been banned',
        banDesc:
          'If you have questions or would like to appeal, please fill in the form below and our team will review it.',
        appealTitle: 'Submit Appeal',
        appealHint:
          'Please describe your situation in detail (5-500 characters).',
        inputPlaceholder: 'Enter your appeal...',
        submitBtn: 'Submit Appeal',
        submitting: 'Submitting...',
        submitSuccess: 'Appeal submitted',
        submitFailed: 'Submission failed, please try again',
        successTitle: 'Appeal Submitted',
        successDesc: 'Our team will review your appeal shortly. Please wait.',
        viewReplies: 'View Admin Replies',
        hideReplies: 'Hide Replies',
        noReplies: 'No replies yet. Submit an appeal and wait for review.',
        adminReply: 'Admin',
        me: 'Me',
        refresh: 'Refresh',
        backBtn: 'Back',
